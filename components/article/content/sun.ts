...
export const sunContent: TopicModalContent = {
  topicName: "Sun",
  ...
  whatComesIn: {
    ...
    condensed: true,
    condensedReason: "The Sun doesn't need anything from Earth to keep shining.",
  },
  ...
  climateEffect: {
    ...
    condensed: true,
    condensedReason: "The Sun isn't changing. The extra heat comes from gases trapping it on Earth.",
  },
