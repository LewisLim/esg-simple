  ...
  return (
    <div className="paper-light calc-page w-full h-full relative">
      <ArticleWrapper title="Carbon">
        ...
        <p>
          Carbon is the building block of all living things - it's in your DNA,
          proteins, the food you eat, and even the CO2 you breathe out.
        </p>

        <h2>The Fundamental Law: Carbon Never Disappears</h2>
        <p>
          Remember the universal law: Matter is neither created nor destroyed,
          only transformed.
        </p>
        <p>
          This means carbon on Earth has been here since the planet formed. It
          just changes form.
        </p>
        <p>Can carbon change form? Yes! It cycles between:</p>
        <p>- Solid (coal, trees, your body)</p>
        <p>- Liquid (oil, dissolved in oceans)</p>
        <p>- Gas (CO2 in the atmosphere)</p>
        ...
        <p>
          ...
          compressed into fossil fuels (coal, oil, gas). This carbon was LOCKED
          UNDERGROUND.
        </p>
        <p>
        ...
        <p>→ Deforestation (removes carbon absorbers)</p>
        ...
        <h2>The Problem: Too Much, Too Fast</h2>
        <p>
          Remember: Carbon cannot be destroyed. When we burn fossil fuels, we're
          NOT making carbon disappear - we're MOVING it from underground into
          the atmosphere.
        </p>
        <p>
          <strong>The crisis:</strong> We release carbon FASTER than Earth's
          natural systems can absorb it back.
        </p>
        <p>
          Result: Carbon accumulates in atmosphere → traps heat → climate change
        </p>
        ...
        <div>
          ...
          <p>Now (2024): [current levels]</p>
          <p>2030: +X°C warming</p>
          <p>2050: +Y°C warming</p>
          <p>2100: +Z°C warming</p>
          <p>2200: Potentially catastrophic levels</p>
        </div>

        <h2>The Carbon Budget: How Much Time Do We Have?</h2>
        <p>
          Scientists have calculated a "carbon budget" - the maximum amount of
          CO2 we can emit before exceeding 1.5°C or 2°C warming.
        </p>
        <p>At current rates, we'll exhaust the 1.5°C budget by [year]</p>
        <p>
          Beyond certain thresholds, Earth's systems hit "tipping points" -
          irreversible changes like Amazon rainforest die-off or Greenland ice
          sheet collapse.
        </p>
        ...
        <p>
          → Every carbon atom in your body was once in a dinosaur, a tree, or
          the ocean
        </p>
        <p>→ A single tree can absorb 48 pounds of CO2 per year</p>
        <p>→ The oceans have absorbed 30% of human CO2 emissions</p>
        <p>
          → Your breath contains about 40,000 parts per million of CO2 - 100x
          more than the air!
        </p>
        ...
        <h2>What else is related to this? (Links)</h2>
        <p>→ Climate Change</p>
        <p>→ Greenhouse Gases (methane, etc.)</p>
        <p>→ Renewable Energy Solutions</p>
        <p>→ Forests and Biodiversity</p>
      </ArticleWrapper>
    </div>
  );
}
