...
export default function LearnEnvironment() {
  return (
    <div className="article paper-light calc-page w-full h-full relative">
      <ArticleWrapper title="Carbon">
        <div>
          <h2>What is Carbon?</h2>
          <p>
            Carbon is the building block of all living things - it's in your
            DNA, proteins, the food you eat, and the CO2 you breathe out.
          </p>
        </div>
        <div>
        ...
        <div>
          ...
          <p>
            ...
            we're NOT making carbon disappear - we're MOVING it from underground
            into the atmosphere.
          </p>
          <p>
          ...
          <p>
            Result: Carbon accumulates in atmosphere → traps heat → climate
            change
          </p>
        </div>
